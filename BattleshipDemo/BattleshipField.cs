...
namespace BattleshipDemo
{
    public class BattleshipField
    {
        ...
        public bool checkEnabled(int line, int x, int y, int deckCount, int[,] field)
        {
            ...
            {
                System.Console.WriteLine("Out of bound: Please reenter this deck");
                return false;
            }
            ...
            for (int i = -1; i <= deckCount; i++)
            {
                if(line == 1)
                {
                    ...
                    {
                        System.Console.WriteLine("Can't place nearby, please find another place!");
                        return false;
                    }
                }else{
